        ...
        switch (actResp) {
            case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
                errorDialog = makeSimpleDialog(ctx.getString(
                        R.string.gamehelper_app_misconfigured) + " " + getSHA1CertFingerprint());
            ...
            case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
               ...
               // 79:56:0E:A2:37:95:E0:EC:50:35:84:18:86:04:7F:23:75:2E:65:2D
    ...
    static String errorCodeToString(int errorCode) {
        switch (errorCode) {
            ...
            case ConnectionResult.NETWORK_ERROR:
            	...
            	//11-06 13:09:59.781: D/CollectAllTheStars(31646): GameHelper: **** Cert SHA1 fingerprint: 09:B3:C9:04:A7:F2:D3:CA:D0:B0:44:4A:4F:49:70:01:4C:68:47:31
